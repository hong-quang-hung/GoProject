...
func Leetcode_Max_Num_Edges_To_Removet() {
	...
	fmt.Println("Output:", maxNumEdgesToRemove(4, utils.S2SoSliceInt("[[3,1,2],[3,2,3],[1,1,3],[1,2,4],[1,1,2],[2,3,4]]")))
	fmt.Println("Input: n = 4, edges = [[3,1,2],[3,2,3],[1,1,4],[2,1,4]]")
	fmt.Println("Output:", maxNumEdgesToRemove(4, utils.S2SoSliceInt("[[3,1,2],[3,2,3],[1,1,4],[2,1,4]]")))
	fmt.Println("Input: n = 4, edges = [[3,2,3],[1,1,2],[2,3,4]]")
	fmt.Println("Output:", maxNumEdgesToRemove(4, utils.S2SoSliceInt("[[3,2,3],[1,1,2],[2,3,4]]")))
}

func maxNumEdgesToRemove(n int, edges [][]int) int {
	res, unionA, unionB := len(edges), types.NewUnionFind(n+1), types.NewUnionFind(n+1)
