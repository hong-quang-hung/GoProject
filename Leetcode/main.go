...
func init() {
	...
	_PROBLEM_DEBUG_ = 100933 - solutions.Normalize
...
func LeetcodeInfomation() {
	...
	Leetcode.SetSolved(3, 13, 23, 103, 133, 213, 263, 283, 313, 443, 583, 643, 703, 783, 933, 953, 983, 1143, 1493, 1523, 1603, 2583, 2623, 2633, 2643, 2653, 2673, 2683, 2693, 2703, 2723, 2733)
