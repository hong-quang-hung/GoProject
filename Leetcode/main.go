...
func init() {
	...
	_PROBLEM_DEBUG_ = 101318 - solutions.Normalize
...
func LeetcodeInfomation() {
	...
	Leetcode.SetSolved(3, 13, 23, 103, 133, 213, 263, 313, 443, 703, 783, 953, 983, 1523, 1603, 2583, 2623, 2633, 2643, 2653, 2673, 2683, 2693)
