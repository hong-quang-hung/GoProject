...
func init() {
	...
	_PROBLEM_DEBUG_ = 102637 - solutions.Normalize

	_PROBLEM_TOTAL_ = 2701
}
...
func LeetcodeInfomation() {
	...
	Leetcode.SetSolved(7, 17, 27, 67, 77, 87, 337, 347, 377, 427, 567, 1047, 1137, 1207, 1557, 1697, 1857, 2187, 2477, 2547, 2567, 2587, 2597, 2637, 2657, 2667, 2697)
