...
func init() {
	_PROBLEM_DEBUG_ = 100022 - solutions.Normalize
...
func LeetcodeInfomation() {
	...
	Leetcode.SetSolved(6, 649, 438, 38, 54, 59, 1035, 2140, 2466, 231, 326, 342, 36, 2678, 2680, 2679, 2682, 2683, 2684, 2685, 1799, 2646, 22)
