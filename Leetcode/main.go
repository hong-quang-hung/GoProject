...
func GetRandomProblem() {
	...
	Leetcode.SetSolved(769, 1944, 87, 2145, 601, 1444, 704, 2605, 2606, 2610, 32, 2609, 2300, 2306, 45, 2547, 881)
	...
	// fmt.Println("Problem", Leetcode.GetSolved(), "th has been solved.")
}
