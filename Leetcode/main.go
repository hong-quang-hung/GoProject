...
func init() {
	...
	_PROBLEM_DEBUG_ = 101201 - solutions.Normalize
	_PROBLEM_TOTAL_ = 2654
}
...
func LeetcodeInfomation() {
	...
	Leetcode.SetSolved(1312, 337, 2520, 202, 141, 849, 2653, 2652, 2651, 204, 1979, 2654, 1416, 118, 119, 1046, 309, 2336, 258, 1582, 319, 263, 264, 279, 313)
